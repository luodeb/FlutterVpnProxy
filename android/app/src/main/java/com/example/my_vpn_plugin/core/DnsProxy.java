...
import com.example.my_vpn_plugin.dns.DnsPacket;
import com.example.my_vpn_plugin.dns.Question;
import com.example.my_vpn_plugin.dns.Resource;
import com.example.my_vpn_plugin.dns.ResourcePointer;
import com.example.my_vpn_plugin.tcpip.CommonMethods;
import com.example.my_vpn_plugin.tcpip.IPHeader;
import com.example.my_vpn_plugin.tcpip.UDPHeader;
    ...
    public synchronized void stop() {
        ...
        if (m_Client != null) {
            try {
                ...
                Log.e(com.example.my_vpn_plugin.core.Constant.TAG, "Exception when closing m_Client", e);
            } finally {
                m_Client = null;
            }
        }
